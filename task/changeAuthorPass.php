...
$chg_pwd="select * from user where name = '".$_SESSION['author_name']."'";
$result=$conn->query($chg_pwd);
$chg_pwd1=$result->fetch_array();
$data_pwd=$chg_pwd1['password'];
if($data_pwd==$oldpass){
if($npassword==$cpassword){
$update_pwd= "update user set password='".$npassword."' where name = '".$_SESSION['author_name']."'";
...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <p>go back to<a href="author_page.php">home page</a></p>
   </form>
